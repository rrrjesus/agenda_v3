                    ...
                    if ( !called ) {
                        ...
                        if ( this.settings.debug && window.console ) {
                            console.warn(
                                ...
                                "Por favor, não o use, pois ele depende do construtor Date, que\n" +
                                "se comporta de maneira muito diferente entre navegadores e localidades. Use `dateISO`\n" +
                                "em vez disso ou um dos métodos específicos de localidade em `localizações/`\n" +
                                "e `métodos adicionais.js`."
                            );
                        }
                    }
